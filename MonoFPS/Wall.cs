...
namespace MonoFPS
{
    public class Wall : Entity
    {
        ...
        public Wall(Vector3 position, float width, float length, GraphicsDevice gd)
        {
            ...
            _scale = new Vector3(width * Globals.WORLD_SCALE, 3 * Globals.WORLD_SCALE, length * Globals.WORLD_SCALE);
        ...
        private void InitializeEffect()
        {
            ...
            _effect.DirectionalLight0.Direction = new Vector3(0.5f, 0.5f, 0.5f);
            ...
            _effect.DirectionalLight1.Direction = new Vector3(-1.0f, 0.0f, 0.0f);
